    ...
    <>
      <L.Main>
        <L.Baner>
          ...
          <L.pri>
            <L.Name> {data?.fetchBoard.writer} </L.Name>{" "}
            <L.Day>Date: {data?.fetchBoard.createdAt.slice(0, 10)}</L.Day>
          </L.pri>
        ...
        <L.Like>
          <div>
            <L.LikeOut onClick={up} />
            <L.Up>{data?.fetchBoard.likeCount}</L.Up>
          </div>
          <div>
            <L.DislikeOut onClick={down} />
            <L.Down>{data?.fetchBoard.dislikeCount}</L.Down>
          </div>
        </L.Like>
        <L.buttonGroup>
