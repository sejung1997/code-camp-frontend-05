...
import { IBoardUIIProps } from "./Example.types"
...
export default function BoardWriteUI(props:IBoardUIIProps) {
  ...
  return (
    ...
    작성자: <aaaa.MyInput type="text" onChange={props.ddd}  defaultValue={props.aaa? props.data?.fetchBoard.writer :''}/><br/>
    제목: <aaaa.MyInput type="text" onChange={props.fff}  defaultValue={props.aaa?  props.data?.fetchBoard.title : ''}/><br/>
    내용: <aaaa.MyInput type="text" onChange={props.eee}  defaultValue={props.aaa?  props.data?.fetchBoard.contents : ''}/><br/>
    <aaaa.MyButton
